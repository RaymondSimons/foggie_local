...
clrs = ['red', 'blue', 'navy', 'darkblue', 'royalblue']
ls = ['-', '-', ':', '--','-.']
lw = [2,2,2,2,2]
...
for s, sim in enumerate(array(['forced', 'natural(v1)', 'natural(v2)', 'natural(v3)', 'natural(v4)'])):
    ...
    for DD in DDs_use:
        ...
        if sim == 'natural(v1)': simname = 'natural'
        if sim == 'natural(v2)': simname = 'nref11n_v2_selfshield_z15'
        if sim == 'natural(v3)': simname = 'nref11n_v3_selfshield_z15'
        if sim == 'natural(v4)': simname = 'nref11n_v4_selfshield_z15'
...
fig.savefig('/Users/rsimons/Dropbox/rcs_foggie/figures/comparison_mass.png', dpi = 300)
fig2.savefig('/Users/rsimons/Dropbox/rcs_foggie/figures/comparison_SFR.png', dpi = 300)
